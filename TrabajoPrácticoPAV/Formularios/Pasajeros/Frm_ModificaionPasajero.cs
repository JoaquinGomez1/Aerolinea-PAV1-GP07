...
{
    public partial class Frm_ModificaionPasajero : Form
    {
        ...
        public Frm_ModificaionPasajero()
        {
            InitializeComponent();
        }

        private void Frm_ModificaionPasajero_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_Modificar_Click(object sender, EventArgs e)
        {
            ...
            Resultado validar = _TE.Validar(this.Controls);
