...
namespace TrabajoPrácticoPAV.Formularios.Provincia
{
    public partial class Frm_ABMProvincia : Form
    {
        ...
        {
            if (verificar_seleccion(cmb_Pais, txt_Nombre, txt_idProvincia))
            {
        ...
        private bool verificar_seleccion(ComboBox_Aerolinea pais, TextBox_Aerolinea nombre, MaskedTextBox_Aerolinea id)
        {
            if (pais.SelectedIndex == -1 & nombre.Text == "" & id.Text == "")
            {
