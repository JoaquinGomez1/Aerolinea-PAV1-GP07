...
{
    public partial class Frm_EliminarFactura : Form
    {
        ...
        private void Frm_EliminarFactura_Load(object sender, EventArgs e)
        {
        ...
        {
            facturacion.Eliminar(txt_numeroFactura.Text);
            this.Close();
        }
